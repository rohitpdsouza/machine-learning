...
setwd("C:/Users/prohi/PycharmProjects/POC/ML")

borrower <- read_excel("data/output/borrowers_with_clusters_vae_2.xlsx")
print(borrower)
glimpse(borrower)
...
ggsave(
  "data/output/credit_utilization_dist.jpeg",
  plot = cred_util_dist,
  width = 6,
  height = 4,
  dpi = 300
...
ggsave(
  "data/output/income_vol_dist.jpeg",
